<template>
  <main class="detail">
    ...
    <div class="details">
      ...
      <div class="address">
        <p class="address-street">{{ invoice.address }}</p>
        <p class="address-city">{{ invoice.city }}</p>
        <p class="address-postcode">{{ invoice.postCode }}</p>
        <p class="address-country">{{ invoice.country }}</p>
      </div>
      <div class="date">
        <p class="date-label">Order Date</p>
      ...
      <div class="due">
        <p class="due-label">Order Due</p>
        <p class="due-body">{{ invoice.invoiceDue }}</p>
      </div>
      <div class="client-address">
        <p class="client-street">{{ invoice.clientAddress }}</p>
...
export default {
  ...
  computed: {
    ...
    invoice() {
      return this.filteredOrders[this.index];
    },
  },
  methods: {
    ...mapMutations([
