      ...
      <form class="form">
        ...
        <div class="input-item">
          <label
            class="form__label"
            :class="{
              error: $v.invoiceForm.address.$error,
            }"
            for="street"
          >
            Street Address
          ...
          <input
            class="form__input"
            :class="{
              errorborder: $v.invoiceForm.address.$error,
            }"
            v-model.trim="$v.invoiceForm.address.$model"
            type="text"
            name="street"
            id="street"
          />
        ...
        <div class="input-item">
          <label
            class="form__label"
            :class="{
              error: $v.invoiceForm.clientAddress.$error,
            }"
            for="client-street"
          >
            Client's Address
          ...
          <input
            class="form__input"
            :class="{
              errorborder: $v.invoiceForm.clientAddress.$error,
            }"
            v-model.trim="$v.invoiceForm.clientAddress.$model"
            type="text"
            name="clientStreet"
            id="client-street"
          />
        ...
        <div class="input-group">
          <div class="input-item" style="width: 47%">
            <label for="invoice-date"> Order Date </label>
            <input
